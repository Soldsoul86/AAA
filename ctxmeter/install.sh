#!/bin/sh
# Installs the latest release of ctxmeter from GitHub Releases.
# Usage: curl -fsSL https://raw.githubusercontent.com/Soldsoul86/AAA/main/ctxmeter/install.sh | sh
#
# This repo holds four tools. Each tool's release is uniquely tagged
# "vX.Y.Z+ctxmeter" (semver build metadata, so it can never collide with
...
# Full release tag, e.g. "v0.1.0+ctxmeter"
