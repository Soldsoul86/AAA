#!/bin/sh
# Installs the latest release of permit from GitHub Releases.
# Usage: curl -fsSL https://raw.githubusercontent.com/Soldsoul86/AAA/main/permit/install.sh | sh
#
# This repo holds four tools. Each tool's release is uniquely tagged
# "vX.Y.Z+permit" (semver build metadata, so it can never collide with
...
# Full release tag, e.g. "v0.1.0+permit"
...
# used in the archive filename: "v0.1.0+permit" -> "0.1.0"
