#!/bin/sh
# Installs the latest release of checkpoint from GitHub Releases.
# Usage: curl -fsSL https://raw.githubusercontent.com/Soldsoul86/AAA/main/checkpoint/install.sh | sh
#
# This repo holds four tools. Each tool's release is uniquely tagged
# "vX.Y.Z+checkpoint" (semver build metadata, so it can never collide with
...
# Full release tag, e.g. "v0.1.0+checkpoint"
