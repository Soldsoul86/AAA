#!/bin/sh
# Installs the latest release of actually from GitHub Releases.
# Usage: curl -fsSL https://raw.githubusercontent.com/Soldsoul86/AAA/main/actually/install.sh | sh
#
# This repo holds several tools. Each tool's release is uniquely tagged
# "vX.Y.Z+actually" (semver build metadata, so it can never collide with
...
# Full release tag, e.g. "v0.1.0+actually"
...
# used in the archive filename: "v0.1.0+actually" -> "0.1.0"
